...
return [
    ...
    */
    ...
    'ends_with' => 'يجب أن ينتهي :attribute بأحد الخيارات التالية: :values.',
    ...
    'custom_errors' => [
        'store_name' => [
            ...
            'string' => 'اسم النشاط التجاري  يجب أن يكون نصًا صالحًا.',
            'max' => 'اسم النشاط التجاري  لا يمكن أن يتجاوز :max حرفًا.',
        ],
        'store_meta' => [
            'required' => 'البيانات الوصفية للمتجر مطلوبة.',
            'string' => 'البيانات الوصفية للمتجر يجب أن تكون نصًا صالحًا.',
            'max' => 'البيانات الوصفية للمتجر لا يمكن أن تتجاوز :max حرفًا.',
            'unique' => 'البيانات الوصفية للمتجر يجب أن تكون فريدة. هذا موجود بالفعل.',
        ],
        'telephone' => [
            'required' => 'رقم الهاتف مطلوب.',
            'string' => 'رقم الهاتف يجب أن يكون نصًا صالحًا.',
            'max' => 'رقم الهاتف لا يمكن أن يتجاوز :max حرفًا.',
            'unique' => 'رقم الهاتف هذا مستخدم بالفعل.',
        ],
        'phone_code' => [
            'required' => 'رمز الهاتف مطلوب.',
            'string' => 'رمز الهاتف يجب أن يكون نصًا صالحًا.',
            'max' => 'رمز الهاتف لا يمكن أن يتجاوز :max حرفًا.',
        ],
        'country_code' => [
            'required' => 'رمز الدولة مطلوب.',
            'string' => 'رمز الدولة يجب أن يكون نصًا صالحًا.',
            'max' => 'رمز الدولة لا يمكن أن يتجاوز :max حرفًا.',
        ],
        'fullname' => [
            'required' => 'الاسم الكامل مطلوب.',
            'string' => 'الاسم الكامل يجب أن يكون نصًا صالحًا.',
            'max' => 'الاسم الكامل لا يمكن أن يتجاوز :max حرفًا.',
        ],
        'password' => [
            'required' => 'كلمة المرور مطلوبة.',
            'string' => 'كلمة المرور يجب أن تكون نصًا صالحًا.',
            'min' => 'كلمة المرور يجب أن تحتوي على الأقل :min حرفًا.',
